...
Task("__CloneTestedLibraryTemplate")
	.Does(() => {
		...
		var args = new ProcessArgumentBuilder()
					.Append($"clone https://github:{apiKey}@github.com/TristanRhodes/Template.TestedLibrary.git");
...
Task("__CloneTestedApiTemplate")
	.Does(() => {
		...
		var args = new ProcessArgumentBuilder()
					.Append($"clone https://github:{apiKey}@github.com/TristanRhodes/Template.TestedApi.git");
